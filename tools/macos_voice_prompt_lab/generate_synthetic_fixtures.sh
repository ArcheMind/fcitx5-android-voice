...
render zh-multiturn-1 Tingting '请提醒我下午三点开会。'
render zh-multiturn-2 Tingting '然后给妈妈打电话。'
render zh-multiturn-3 Tingting '天气怎么样？'
render en-multiturn-1 Samantha 'Remind me to join the meeting at three this afternoon.'
render en-multiturn-2 Samantha 'Then call my mother.'
render en-multiturn-3 Samantha 'What will the weather be like?'
render zh-continuation-1 Tingting '我想明天上午十点'
render zh-continuation-2 Tingting '去图书馆看书。'
